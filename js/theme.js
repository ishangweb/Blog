...
function setHeader() {
    ...
    function setSiteNavBarBg(){
        var getScrollTo =seeMore.getAttribute('data-scroll-to');
        var scrollTop = document.documentElement.scrollTop || document.body.scrollTop;
        var transparency = scrollTop / parseInt(getScrollTo);
        if (scrollTop >= parseInt(getScrollTo)) {
...
function mobiNav() {
    ...
    var ModalHelper = (function() {
        ...
        return {
            afterOpen: function() {
                mScrollTop =  (document.body.scrollTop || document.documentElement.scrollTop);
                document.body.style.position = 'fixed';
                document.body.style.top = -mScrollTop + 'px';
                document.body.style.width =  '100%';
            },
            beforeClose: function() {
                // scrollTop lost after set position:fixed, restore it back.
                document.body.removeAttribute('style')
                document.documentElement.scrollTop = document.body.scrollTop = mScrollTop;
            }
        };
    })();
